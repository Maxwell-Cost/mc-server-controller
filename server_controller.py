...
async def control_server(action):
    ...
    if not server_instance:
        print(f"     [{ERROR}Warning{RESET}] Could not find an instance matching friendly name '{INSTANCE_NAME}'!")
        print("Discovered instances on this node:")
        for inst in controller.instances:
            print(f" - Friendly Name: {inst.friendly_name}")
        return

    print(f"{STATUS}Initialization complete.{RESET}")
    ...
    if action == "start":
        ...
        print(f"{STATUS}Server Launch Sequence Complete.{RESET}")
    ...
    # =========================================================================        
        ...
        print(f"{STATUS}Starting Graceful Shutdown Sequence...{RESET}")
        ...
        print(f"{STATUS}Server Shut Down Sequence Complete.{RESET}")
    ...
    # =========================================================================
        ...
        try:
            ...
            print(f"{STATUS}Backup successfully moved to external storage.{RESET}")
